...
function Profile({ navigation,createProfile ,currentProfile,switchProfile}) {
    ...
    return (
        ...
        >
            ...
            <View style={{width:'100%',marginTop:responsiveHeight(9)}}>
                ...
                style={{backgroundColor:'rgba(85, 0, 166, 0.51)',paddingHorizontal:5,borderRadius:5,width:'30%',marginBottom:responsiveFontSize(1),alignSelf:'center',marginTop:10}}>
                    <Text style={{textAlign:'center',color:'white'}}>Switch Profile</Text>
                </TouchableOpacity>
                ):null}
