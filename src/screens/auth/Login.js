        ...
        style={styles.con}>
            ...
            >
                ...
                <View style={styles.btnCon}>
                    <TouchableOpacity 
                    onPress={fbLogin}
                    style={{...styles.btn,borderWidth:1,borderColor:'#4267B2',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                        <Image
                        style={{width:responsiveFontSize(4),height:responsiveFontSize(4)}}
                        source={require('../../../assets/fb.png')}
                        />
                        <Text style={{marginLeft:10,color:'#4267B2',fontSize:responsiveFontSize(2),fontFamily:'Poppins-Medium'}}>Facebook Login</Text>
                    </TouchableOpacity>
                    {/* <TouchableOpacity 
                    onPress={googleLogin}
